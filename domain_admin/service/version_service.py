...
def execute_migrate(local_version):
    ...
    if local_version in [
        ...
        # 1.5.12 => 1.5.13
        logger.info('update version: %s => %s', local_version, VersionEnum.Version_1513)

        migrate_1512_to_1513.execute_migrate()

        local_version = VersionEnum.Version_1513
    ...
    if local_version in [
        ...
        # 1.5.20 => 1.5.21
        logger.info('update version: %s => %s', local_version, VersionEnum.Version_1521)
